...
{
    public sealed class UserFoldersCleanupStep(ISelectiveFolderCleaner selectiveFolderCleaner, IUserProfileProvider userProfileProvider, CleanerConfig config) : ICleanupStep
    {
